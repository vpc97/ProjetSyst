...
static const yytype_uint8 yyrline[] =
{
      ...
      32,    33,    35,    36,    37,    40,    46,    47,    50,    51,
      53,    59,    64,    63,    74,    78,    82,    86,    90,    97,
     106,   115,   122,   131,   140,   149,   158,   167,   176,   182,
     190,   198,   206,   214,   222,   228,   234
};
#endif
...
static const char *const yytname[] =
{
  ...
  "tMAIN", "tCONST", "tSTRING", "tINT", "tVAR", "tIF", "tWHILE", "tFOR",
  "tELSE", "tRETURN", "tDO", "tPRINTF", "tSCANF", "tMULT", "tSOUSTRACTION",
  "tADDITION", "tDIV", "tGUILLEMET", "tCROCHETGAUCHE", "tCROCHETDROIT",
  "tPOINTVIRGULE", "tVIRGULE", "tEGAL", "tDEGAL", "tDIF",
  "tPOINTEXCLAMATION", "tPOINTINTERROGATION", "tINF", "tSUP", "tINFEGAL",
  "tSUPEGAL", "tPLUSPLUS", "tMOINSMOINS", "$accept", "Start", "Body",
  "declarations", "declaration", "decl_type", "dec", "instructions",
  "instruction", "$@1", "boolean", "Exp", YY_NULLPTR
};
#endif
...
{
      -3,   -33,    18,   -33,    16,     1,    48,    12,    78,    39,
      33,   -33,    65,    68,    91,    76,    92,    82,    85,    90,
     105,   -33,    85,   103,    -1,    42,    42,   115,    78,   140,
     -33,   -33,   -33,    99,   -33,    64,   -33,    -1,   -33,    38,
     -33,   -33,    11,    20,    87,   137,   141,   -33,   142,    -1,
     -33,   143,     9,    -1,    -1,    -1,    -1,   -33,   -33,     8,
       8,     8,    42,    42,    42,    42,   145,   136,   -33,   120,
      45,   -33,   102,   -33,   -33,   -33,    44,    44,   -33,   146,
     110,   114,    84,   118,    84,   118,    84,   118,    84,    84,
      84,    84,    78,   121,   -33,   -33,   142,   -33,    78,   147,
      42,   -33,   148,   -33,    75,   -33,   150,    47,   151,   152,
     153,   154,    78,    78,   155,   156,   -33,   -33
};
...
{
       0,     5,     0,     1,     0,     0,     0,     0,     9,     0,
       0,    15,     0,     0,     0,     0,     0,     0,     7,    11,
       0,     8,    19,     0,     0,     0,     0,     0,     9,     0,
       4,     6,    10,     0,    18,     0,    45,     0,    44,     0,
      39,    38,     0,     0,     0,     0,     0,    12,     0,     0,
       3,     0,     0,     0,     0,     0,     0,    20,    22,     0,
       0,     0,     0,     0,     0,     0,     0,     0,    24,     0,
       0,    13,     0,     2,    46,    43,    41,    40,    42,     0,
      39,    38,    28,    31,    29,    32,    30,    33,    34,    35,
      36,    37,     9,     0,    21,    16,     0,    14,     9,     0,
       0,    17,     0,    25,     0,    23,     0,     0,     0,     0,
       0,     0,     9,     9,     0,     0,    26,    27
};
...
{
     -33,   -33,   -28,   139,   -33,   -33,    69,   -14,   -33,   -33,
     -25,   -32
};
...
{
      45,    43,    36,    37,    31,    52,     6,    51,    34,     1,
      38,    80,    37,     7,    74,     9,    58,    72,     3,    81,
       5,    75,    76,    77,    78,    66,     4,    83,    85,    87,
      53,    54,    55,    56,    82,    84,    86,    88,    89,    90,
      91,    59,    60,    61,    23,    40,    62,    63,    64,    65,
      59,    60,    61,    41,     8,    62,    63,    64,    65,    53,
      54,    55,    56,    24,    99,    53,    57,    10,    56,    25,
     102,    50,    26,    95,    96,   104,    11,    12,    13,    14,
      15,    10,    28,    16,   114,   115,   108,   109,    10,    30,
      11,    12,    13,    14,    15,    27,    29,    16,    12,    13,
      14,    15,    11,   106,    16,    59,    60,    61,    33,    35,
      62,    63,    64,    65,    59,    60,    61,    67,    44,    62,
      63,    64,    65,    53,    54,    55,    56,    47,    48,    49,
      97,   -45,   -45,   -45,   -45,   -44,   -44,   -44,   -44,    53,
      54,    55,    56,    46,    68,    70,    69,    93,    94,   100,
      73,    92,    98,   107,   103,   105,   110,   111,    32,   112,
     113,     0,   116,   117,     0,   101
};

static const yytype_int8 yycheck[] =
{
      28,    26,     3,     4,    18,    37,     5,    35,    22,    12,
      11,     3,     4,    12,     5,     3,     5,    49,     0,    11,
       4,    53,    54,    55,    56,     5,     8,    59,    60,    61,
      21,    22,    23,    24,    59,    60,    61,    62,    63,    64,
      65,    30,    31,    32,     5,     3,    35,    36,    37,    38,
      30,    31,    32,    11,     6,    35,    36,    37,    38,    21,
      22,    23,    24,    30,    92,    21,    28,     3,    24,     4,
      98,     7,     4,    28,    29,   100,    12,    13,    14,    15,
      16,     3,     6,    19,   112,   113,    39,    40,     3,     7,
      12,    13,    14,    15,    16,     4,     4,    19,    13,    14,
      15,    16,    12,    28,    19,    30,    31,    32,     3,     6,
      35,    36,    37,    38,    30,    31,    32,    30,     3,    35,
      36,    37,    38,    21,    22,    23,    24,    28,    29,    30,
      28,    21,    22,    23,    24,    21,    22,    23,    24,    21,
      22,    23,    24,     3,     7,     3,     5,    11,    28,    28,
       7,     6,     6,     3,     7,     7,     5,     5,    19,     6,
       6,    -1,     7,     7,    -1,    96
};
...
{
       0,    12,    42,     0,     8,     4,     5,    12,     6,     3,
       3,    12,    13,    14,    15,    16,    19,    43,    44,    45,
      46,    48,    49,     5,    30,     4,     4,     4,     6,     4,
       7,    48,    44,     3,    48,     6,     3,     4,    11,    52,
       3,    11,    51,    51,     3,    43,     3,    28,    29,    30,
       7,    43,    52,    21,    22,    23,    24,    28,     5,    30,
      31,    32,    35,    36,    37,    38,     5,    30,     7,     5,
       3,    47,    52,     7,     5,    52,    52,    52,    52,    50,
       3,    11,    51,    52,    51,    52,    51,    52,    51,    51,
      51,    51,     6,    11,    28,    28,    29,    28,     6,    43,
      28,    47,    43,     7,    51,     7,    28,     3,    39,    40,
       5,     5,     6,     6,    43,    43,     7,     7
};
...
#line 54 "compiler.y" /* yacc.c:1646  */
    { 
				...
				supprimer(); 
				add_mem_instr("STORE", getAdresse((yyvsp[-3].str)), 0, 0);
			}
...
#line 60 "compiler.y" /* yacc.c:1646  */
    {
			add_mem_instr("PRI", getAdresse((yyvsp[-2].str)), 0, 0);
			}
...
#line 91 "compiler.y" /* yacc.c:1646  */
    { 
				add_mem_instr("LOAD", 0, getLast(), 0);
				supprimer(); 
				add_mem_instr("STORE", getAdresse((yyvsp[-2].str)), 0, 0);
				supprimer();
			}
...
#line 177 "compiler.y" /* yacc.c:1646  */
    { 
				inserer_tmp(" ","int");
				add_mem_instr("AFC", 0, (yyvsp[0].nb), 0); 
				add_mem_instr("STORE", getLast(), 0, 0);
			}
...
#line 183 "compiler.y" /* yacc.c:1646  */
    { 
				inserer_tmp(" ","int");
				add_mem_instr("LOAD", 0, getAdresse((yyvsp[0].str)), 0); 
				add_mem_instr("STORE", getLast(), 0, 0);
			}
...
#line 237 "compiler.y" /* yacc.c:1906  */
